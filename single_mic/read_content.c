...
/* store the total file content into memory */
...
/* directly read two target columns from the memory and calculate them */
...
/* a directly nterface with arguments */
/* example useage: cal_mic_ctmem(file_name,x_column,y_column,exp,f) */
